! function(e, t) {
	...
	function r(e) {
		if(!yt[e]) {
			var t = F.body,
				n = H("<" + e + ">").appendTo(t),
				r = n.css("display");
			n.remove(), "none" !== r && "" !== r || (pt || (pt = F.createElement("iframe"), pt.frameBorder = pt.width = pt.height = 0), t.appendChild(pt), ht && pt.createElement || ((ht = (pt.contentWindow || pt.contentDocument).document).write((H.support.boxModel ? "<!doctype html>" : "") + "<html><body>"), ht.close()), n = ht.createElement(e), ht.body.appendChild(n), r = H.css(n, "display"), t.removeChild(pt)), yt[e] = r
		}
		return yt[e]
	}
	...
	function u(e, n) {
		...
		for(r = 1; r < p; r++) {
			...
			if(a = h, "*" === (h = f[r])) h = a;
				...
				}!l && !c && H.error("No conversion from " + s.replace(" ", " to ")), !0 !== l && (n = l ? l(n) : c(u(n)))
			}
		}
		return n
	}
	...
	function p(e, n, r, i, o, a) {
		...
		for(var s, l = e[o], u = 0, c = l ? l.length : 0, f = e === ot; u < c && (f || !s); u++) "string" == typeof(s = l[u](n, r, i)) && (!f || a[s] ? s = t : (n.dataTypes.unshift(s), s = p(e, n, r, i, s, a)));
	...
	function h(e) {
		return function(t, n) {
			if("string" != typeof t && (n = t, t = "*"), H.isFunction(n))
				for(var r, i, o = t.toLowerCase().split(tt), a = 0, s = o.length; a < s; a++) r = o[a], (i = /^\+/.test(r)) && (r = r.substr(1) || "*"), (e[r] = e[r] || [])[i ? "unshift" : "push"](n)
		}
	}
	...
	function m(e, t, n) {
		...
		if(r > 0) {
			if("border" !== n)
				for(; i < 4; i += 2) n || (r -= parseFloat(H.css(e, "padding" + We[i])) || 0), "margin" === n ? r += parseFloat(H.css(e, n + We[i])) || 0 : r -= parseFloat(H.css(e, "border" + We[i] + "Width")) || 0;
			return r + "px"
		}
		if(((r = Le(e, t)) < 0 || null == r) && (r = e.style[t]), Oe.test(r)) return r;
		if(r = parseFloat(r) || 0, n)
			for(; i < 4; i += 2) r += parseFloat(H.css(e, "padding" + We[i])) || 0, "padding" !== n && (r += parseFloat(H.css(e, "border" + We[i] + "Width")) || 0), "margin" === n && (r += parseFloat(H.css(e, n + We[i])) || 0);
		return r + "px"
	}
	...
	function y(e) {
		...
		"input" === t ? v(e) : "script" !== t && void 0 !== e.getElementsByTagName && H.grep(e.getElementsByTagName("input"), v)
	}
	...
	function T(e, t) {
		if(1 === t.nodeType && H.hasData(e)) {
			...
			if(s) {
				...
				for(n in s)
					for(r = 0, i = s[n].length; r < i; r++) H.event.add(t, n, s[n][r])
			}
	...
	var F = e.document,
		...
		H = function() {
				...
				init: function(e, n, r) {
					...
					if("string" == typeof e) {
						if((i = "<" !== e.charAt(0) || ">" !== e.charAt(e.length - 1) || e.length < 3 ? c.exec(e) : [null, e, null]) && (i[1] || !n)) {
							if(i[1]) return n = n instanceof s ? n[0] : n, l = n ? n.ownerDocument || n : F, (a = h.exec(e)) ? s.isPlainObject(n) ? (e = [F.createElement(a[1])], s.fn.attr.call(e, n, !0)) : e = [l.createElement(a[1])] : (a = s.buildFragment([i[1]], [l]), e = (a.cacheable ? s.clone(a.fragment) : a.fragment).childNodes), s.merge(this, e);
			...
			}), (i = s.uaMatch(k)).browser && (s.browser[i.browser] = !0, s.browser.version = i.version), s.browser.webkit && (s.browser.safari = !0), f.test("聽") && (d = /^[\s\xA0]+/, p = /[\s\xA0]+$/), r = s(F), F.addEventListener ? a = function() {
	...
	H.Callbacks = function(e) {
		...
		var n, r, i, o, a, s, l = [],
			...
			c = function(t) {
				var n, r, i, o;
				for(n = 0, r = t.length; n < r; n++) i = t[n], "array" === (o = H.type(i)) ? c(i) : "function" === o && (!e.unique || !d.has(i)) && l.push(i)
			},
			f = function(t, c) {
	...
	H.extend({
						...
						return H.Deferred(function(r) {
							H.each({
								...
								H.isFunction(i) ? l[e](function() {
									(n = i.apply(this, arguments)) && H.isFunction(n.promise) ? n.promise().then(r.resolve, r.reject, r.notify) : r[o + "With"](this === l ? r : this, [n])
								}) : l[e](r[o])
							})
						}).promise()
					},
		...
		when: function(e) {
			var t = B.call(arguments, 0),
				...
				i = Array(r),
				o = r,
				a = r <= 1 && e && H.isFunction(e.promise) ? e : H.Deferred(),
				s = a.promise();
			if(r > 1) {
				for(; n < r; n++) t[n] && t[n].promise && H.isFunction(t[n].promise) ? t[n].promise().then(function(e) {
					return function(n) {
						t[e] = arguments.length > 1 ? B.call(arguments, 0) : n, --o || a.resolveWith(a, t)
					}
				}(n), a.reject, function(e) {
					return function(t) {
						i[e] = arguments.length > 1 ? B.call(arguments, 0) : t, a.notifyWith(s, i)
					}
				}(n)) : --o;
				o || a.resolveWith(a, t)
		...
		o = (i = F.createElement("select")).appendChild(F.createElement("option")), a = d.getElementsByTagName("input")[0], t = {
		...
		if(!d.addEventListener && d.attachEvent && d.fireEvent && (d.attachEvent("onclick", function() {
				t.noCloneEvent = !1
			}), d.cloneNode(!0).fireEvent("onclick")), a = F.createElement("input"), a.value = "t", a.setAttribute("type", "radio"), t.radioValue = "t" === a.value, a.setAttribute("checked", "checked"), a.setAttribute("name", "t"), d.appendChild(a), (s = F.createDocumentFragment()).appendChild(d.lastChild), t.checkClone = s.cloneNode(!0).cloneNode(!0).lastChild.checked, t.appendChecked = a.checked, s.removeChild(a), s.appendChild(d), d.attachEvent)
			for(c in {
					submit: 1,
					change: 1,
					focusin: 1
				}) u = "on" + c, (f = u in d) || (d.setAttribute(u, "return;"), f = "function" == typeof d[u]), t[c + "Bubbles"] = f;
		return s.removeChild(d), s = i = o = d = a = null, H(function() {
			...
			!y || (u = 1, g = "padding:0;margin:0;border:", h = "position:absolute;top:0;left:0;width:1px;height:1px;", m = g + "0;visibility:hidden;", c = "style='" + h + g + "5px solid #000;", p = "<div " + c + "display:block;'><div style='" + g + "0;display:block;overflow:hidden;'></div></div><table " + c + "' cellpadding='0' cellspacing='0'><tr><td></td></tr></table>", n = F.createElement("div"), n.style.cssText = m + "width:0;height:0;position:static;top:0;margin-top:" + u + "px", y.insertBefore(n, y.firstChild), d = F.createElement("div"), n.appendChild(d), d.innerHTML = "<table><tr><td style='" + g + "0;display:none'></td><td>t</td></tr></table>", l = d.getElementsByTagName("td"), f = 0 === l[0].offsetHeight, l[0].style.display = "", l[1].style.display = "none", t.reliableHiddenOffsets = f && 0 === l[0].offsetHeight, e.getComputedStyle && (d.innerHTML = "", s = F.createElement("div"), s.style.width = "0", s.style.marginRight = "0", d.style.width = "2px", d.appendChild(s), t.reliableMarginRight = 0 === (parseInt((e.getComputedStyle(s, null) || {
				...
				marginTop: 0
			}).marginTop), void 0 !== n.style.zoom && (n.style.zoom = 1), y.removeChild(n), s = d = n = null, H.extend(t, a))
		}), t
	}();
	var P = /^(?:\{.*\}|\[.*\])$/,
		q = /([A-Z])/g;
	H.extend({
		...
		hasData: function(e) {
			return !!(e = e.nodeType ? H.cache[e[H.expando]] : e[H.expando]) && !L(e)
		},
		data: function(e, n, r, i) {
			if(H.acceptData(e)) {
				...
				return d || (c ? e[l] = d = ++H.uuid : d = l), f[d] || (f[d] = {}, c || (f[d].toJSON = H.noop)), "object" != typeof n && "function" != typeof n || (i ? f[d] = H.extend(f[d], n) : f[d].data = H.extend(f[d].data, n)), o = a = f[d], i || (a.data || (a.data = {}), a = a.data), r !== t && (a[H.camelCase(n)] = r), p && !a[n] ? o.events : (u ? null == (s = a[n]) && (s = a[H.camelCase(n)]) : s = a, s)
			}
		},
		...
		data: function(e, n) {
			...
			if(e === t) {
				if(this.length && (c = H.data(l), 1 === l.nodeType && !H._data(l, "parsedAttrs"))) {
					for(s = (o = l.attributes).length; u < s; u++) 0 === (a = o[u].name).indexOf("data-") && (a = H.camelCase(a.substring(5)), D(l, a, c[a]));
			...
			return "object" == typeof e ? this.each(function() {
				...
				if(n === t) return(c = this.triggerHandler("getData" + i, [r[0]])) === t && l && (c = H.data(l, e), c = D(l, e, c)), c === t && r[1] ? this.data(r[0]) : c;
	...
	H.fn.extend({
		...
		addClass: function(e) {
			...
			if(e && "string" == typeof e)
				for(t = e.split(X), n = 0, r = this.length; n < r; n++)
		...
		removeClass: function(e) {
			...
			if(e && "string" == typeof e || e === t)
				for(n = (e || "").split(X), r = 0, i = this.length; r < i; r++)
		...
		val: function(e) {
			...
			return arguments.length ? (i = H.isFunction(e), this.each(function(r) {
				var o, a = H(this);
				1 === this.nodeType && (null == (o = i ? e.call(this, r, a.val()) : e) ? o = "" : "number" == typeof o ? o += "" : H.isArray(o) && (o = H.map(o, function(e) {
					return null == e ? "" : e + ""
				})), (n = H.valHooks[this.type] || H.valHooks[this.nodeName.toLowerCase()]) && "set" in n && n.set(this, o, "value") !== t || (this.value = o))
			})) : o ? (n = H.valHooks[o.type] || H.valHooks[o.nodeName.toLowerCase()]) && "get" in n && (r = n.get(o, "value")) !== t ? r : "string" == typeof(r = o.value) ? r.replace(z, "") : null == r ? "" : r : void 0
		}
	}), H.extend({
		valHooks: {
			option: {
			...
			select: {
				get: function(e) {
					...
					for(n = l ? o : 0, r = l ? o + 1 : s.length; n < r; n++)
						if((i = s[n]).selected && (H.support.optDisabled ? !i.disabled : null === i.getAttribute("disabled")) && (!i.parentNode.disabled || !H.nodeName(i.parentNode, "optgroup"))) {
		...
		attr: function(e, n, r, i) {
			...
			if(e && 3 !== l && 8 !== l && 2 !== l) return i && n in H.attrFn ? H(e)[n](r) : void 0 === e.getAttribute ? H.prop(e, n, r) : ((s = 1 !== l || !H.isXMLDoc(e)) && (n = n.toLowerCase(), a = H.attrHooks[n] || (Y.test(n) ? I : W)), r !== t ? null === r ? void H.removeAttr(e, n) : a && "set" in a && s && (o = a.set(e, r, n)) !== t ? o : (e.setAttribute(n, "" + r), r) : a && "get" in a && s && null !== (o = a.get(e, n)) ? o : null === (o = e.getAttribute(n)) ? t : o)
		},
		removeAttr: function(e, t) {
			var n, r, i, o, a, s = 0;
			if(t && 1 === e.nodeType)
				for(o = (r = t.toLowerCase().split(X)).length; s < o; s++)(i = r[s]) && (n = H.propFix[i] || i, (a = Y.test(i)) || H.attr(e, i, ""), e.removeAttribute(J ? i : n), a && n in e && (e[n] = !1))
		},
		attrHooks: {
			type: {
				set: function(e, t) {
			...
			value: {
				...
				set: function(e, t, n) {
					if(W && H.nodeName(e, "button")) return W.set(e, t, n);
					e.value = t
				}
			}
		},
		...
		prop: function(e, n, r) {
			...
			if(e && 3 !== a && 8 !== a && 2 !== a) return(1 !== a || !H.isXMLDoc(e)) && (n = H.propFix[n] || n, o = H.propHooks[n]), r !== t ? o && "set" in o && (i = o.set(e, r, n)) !== t ? i : e[n] = r : o && "get" in o && null !== (i = o.get(e, n)) ? i : e[n]
		},
		propHooks: {
			tabIndex: {
				get: function(e) {
		...
		set: function(e, t, n) {
			var r;
			return !1 === t ? H.removeAttr(e, n) : ((r = H.propFix[n] || n) in e && (e[r] = !0), e.setAttribute(n, n.toLowerCase())), n
		}
	}, J || ($ = {
		name: !0,
		id: !0,
		...
		get: function(e, n) {
			var r;
			return(r = e.getAttributeNode(n)) && ($[n] ? "" !== r.nodeValue : r.specified) ? r.nodeValue : t
		},
		set: function(e, t, n) {
	...
	H.event = {
			add: function(e, n, r, i, o) {
				...
				if(3 !== e.nodeType && 8 !== e.nodeType && n && r && (a = H._data(e))) {
					for(r.handler && (h = r, r = h.handler, o = h.selector), r.guid || (r.guid = H.guid++), (l = a.events) || (a.events = l = {}), (s = a.handle) || (a.handle = s = function(e) {
							return void 0 === H || e && H.event.triggered === e.type ? t : H.event.dispatch.apply(s.elem, arguments)
						}, s.elem = e), n = H.trim(ae(n)).split(" "), u = 0; u < n.length; u++) f = (c = K.exec(n[u]) || [])[1], d = (c[2] || "").split(".").sort(), g = H.event.special[f] || {}, f = (o ? g.delegateType : g.bindType) || f, g = H.event.special[f] || {}, p = H.extend({
						type: f,
						origType: c[1],
						data: i,
						handler: r,
						...
						quick: o && ie(o),
						namespace: d.join(".")
					}, h), (m = l[f]) || ((m = l[f] = []).delegateCount = 0, g.setup && !1 !== g.setup.call(e, i, d, s) || (e.addEventListener ? e.addEventListener(f, s, !1) : e.attachEvent && e.attachEvent("on" + f, s))), g.add && (g.add.call(e, p), p.handler.guid || (p.handler.guid = r.guid)), o ? m.splice(m.delegateCount++, 0, p) : m.push(p), H.event.global[f] = !0;
					e = null
				}
			},
			global: {},
				...
				if(y && (d = y.events)) {
					for(t = H.trim(ae(t || "")).split(" "), o = 0; o < t.length; o++)
						if(a = K.exec(t[o]) || [], s = l = a[1], u = a[2], s) {
							for(p = H.event.special[s] || {}, c = (m = d[s = (r ? p.delegateType : p.bindType) || s] || []).length, u = u ? new RegExp("(^|\\.)" + u.split(".").sort().join("\\.(?:.*\\.)?") + "(\\.|$)") : null, f = 0; f < m.length; f++) g = m[f], (i || l === g.origType) && (!n || n.guid === g.guid) && (!u || u.test(g.namespace)) && (!r || r === g.selector || "**" === r && g.selector) && (m.splice(f--, 1), g.selector && m.delegateCount--, p.remove && p.remove.call(e, g));
							0 === m.length && c !== m.length && ((!p.teardown || !1 === p.teardown.call(e, u)) && H.removeEvent(e, s, y.handle), delete d[s])
						} else
							for(s in d) H.event.remove(e, s + t[o], n, r, !0);
					H.isEmptyObject(d) && ((h = y.handle) && (h.elem = null), H.removeData(e, ["events", "handle"], !0))
				}
			},
			customEvent: {
				getData: !0,
			...
			trigger: function(n, r, i, o) {
				if(!i || 3 !== i.nodeType && 8 !== i.nodeType) {
					...
					if(n.result = t, n.target || (n.target = i), (r = null != r ? H.makeArray(r) : []).unshift(n), (d = H.event.special[g] || {}).trigger && !1 === d.trigger.apply(i, r)) return;
					if(h = [
							[i, d.bindType || g]
					...
					for(l = 0; l < h.length && !n.isPropagationStopped(); l++) u = h[l][0], n.type = h[l][1], (p = (H._data(u, "events") || {})[n.type] && H._data(u, "handle")) && p.apply(u, r), (p = f && u[f]) && H.acceptData(u) && !1 === p.apply(u, r) && n.preventDefault();
					return n.type = g, !o && !n.isDefaultPrevented() && (!d._default || !1 === d._default.apply(i.ownerDocument, r)) && ("click" !== g || !H.nodeName(i, "a")) && H.acceptData(i) && f && i[g] && ("focus" !== g && "blur" !== g || 0 !== n.target.offsetWidth) && !H.isWindow(i) && ((c = i[f]) && (i[f] = null), H.event.triggered = g, i[g](), H.event.triggered = t, c && (i[f] = c)), n.result
				}
			},
			dispatch: function(n) {
				...
				if(m[0] = n, n.delegateTarget = this, !y.preDispatch || !1 !== y.preDispatch.call(this, n)) {
					if(h && (!n.button || "click" !== n.type))
						for((a = H(this)).context = this.ownerDocument || this, o = n.target; o != this; o = o.parentNode || this)
							if(!0 !== o.disabled) {
			...
			e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || !1 === e.returnValue || e.getPreventDefault && e.getPreventDefault() ? k : S) : this.type = e, t && H.extend(this, t), this.timeStamp = e && e.timeStamp || H.now(), this[H.expando] = !0
		}, H.Event.prototype = {
			...
			setup: function() {
				if(Q.test(this.nodeName)) return "checkbox" !== this.type && "radio" !== this.type || (H.event.add(this, "propertychange._change", function(e) {
		...
		function() {
			...
			var d = function(e, t, n, i) {
				...
				if(w.length > 1 && m.exec(e))
					if(2 === w.length && h.relative[w[0]]) l = x(w[0] + w[1], t, i);
					else
						for(l = h.relative[w[0]] ? [t] : d(w.shift(), t); w.length;) e = w.shift(), h.relative[e] && (e += w.shift()), l = x(e, l, i);
				else if(!i && w.length > 1 && 9 === t.nodeType && !T && h.match.ID.test(w[0]) && !h.match.ID.test(w[w.length - 1]) && (f = d.find(w.shift(), t, T), t = f.expr ? d.filter(f.expr, f.set)[0] : f.set[0]), t)
					for(l = (f = i ? {
							expr: w.pop(),
							set: y(i)
						} : d.find(w.pop(), 1 !== w.length || "~" !== w[0] && "+" !== w[0] || !t.parentNode ? t : t.parentNode, T)).expr ? d.filter(f.expr, f.set) : f.set, w.length > 0 ? u = y(l) : b = !1; w.length;) p = w.pop(), g = p, h.relative[p] ? g = w.pop() : p = "", null == g && (g = t), h.relative[p](u, g, T);
				else u = w = [];
				if(u || (u = l), u || d.error(p || e), "[object Array]" === a.call(u))
					if(b)
						if(t && 1 === t.nodeType)
							for(v = 0; null != u[v]; v++) u[v] && (!0 === u[v] || 1 === u[v].nodeType && d.contains(t, u[v])) && n.push(l[v]);
						else
			...
			var v, b;
			F.documentElement.compareDocumentPosition ? v = function(e, t) {
						...
						d = function(t, n, r, i) {
							if(n = n || F, !i && !d.isXML(n)) {
								...
								if(9 === n.nodeType) {
									...
									try {
										if(!f || c) return y(n.querySelectorAll("[id='" + u + "'] " + t), r)
									} catch(e) {} finally {
	...
	Se.optgroup = Se.option, Se.tbody = Se.tfoot = Se.colgroup = Se.caption = Se.thead, Se.th = Se.td, H.support.htmlSerialize || (Se._default = [1, "div<div>", "</div>"]), H.fn.extend({
		...
		html: function(e) {
			return H.access(this, function(e) {
				...
				if("string" == typeof e && !Te.test(e) && (H.support.leadingWhitespace || !ge.test(e)) && !Se[(ve.exec(e) || ["", ""])[1].toLowerCase()]) {
					e = e.replace(ye, "<$1></$2>");
					try {
						for(; r < i; r++) 1 === (n = this[r] || {}).nodeType && (H.cleanData(n.getElementsByTagName("*")), n.innerHTML = e);
						n = 0
					} catch(e) {}
				}
		...
		domManip: function(e, n, r) {
			...
			if(this[0]) {
				if(s = l && l.parentNode, i = H.support.parentNode && s && 11 === s.nodeType && s.childNodes.length === this.length ? {
					...
					n = n && H.nodeName(o, "tr");
					for(var c = 0, f = this.length, d = f - 1; c < f; c++) r.call(n ? w(this[c]) : this[c], i.cacheable || f > 1 && c < d ? H.clone(a, !0, !0) : a)
				}
		...
		var r, i, o, a, s = e[0];
		return t && t[0] && (a = t[0].ownerDocument || t[0]), a.createDocumentFragment || (a = F), 1 === e.length && "string" == typeof s && s.length < 512 && a === F && "<" === s.charAt(0) && !we.test(s) && (H.support.checkClone || !Ce.test(s)) && (H.support.html5Clone || !Ne.test(s)) && (i = !0, (o = H.fragments[s]) && 1 !== o && (r = o)), r || (r = a.createDocumentFragment(), H.clean(e, a, r, n)), i && (H.fragments[s] = o ? r : 1), {
			fragment: r,
			cacheable: i
		}
	}, H.fragments = {}, H.each({
		...
		clone: function(e, t, n) {
			...
			if(t && (T(e, a), n))
				for(r = b(e), i = b(a), o = 0; r[o]; ++o) T(r[o], i[o]);
			return r = i = null, a
		},
			...
			for(var l, u = 0; null != (l = e[u]); u++)
				if("number" == typeof l && (l += ""), l) {
					if("string" == typeof l)
						if(xe.test(l)) {
							l = l.replace(ye, "<$1></$2>");
							var c, f = (ve.exec(l) || ["", ""])[1].toLowerCase(),
								d = Se[f] || Se._default,
								p = d[0],
							...
							if(!H.support.tbody) {
								var g = be.test(l),
									v = "table" !== f || g ? "<table>" !== d[1] || g ? [] : h.childNodes : h.firstChild && h.firstChild.childNodes;
								for(a = v.length - 1; a >= 0; --a) H.nodeName(v[a], "tbody") && !v[a].childNodes.length && v[a].parentNode.removeChild(v[a])
							}!H.support.leadingWhitespace && ge.test(l) && h.insertBefore(t.createTextNode(ge.exec(l)[0]), h.firstChild), l = h.childNodes, h && (h.parentNode.removeChild(h), m.length > 0 && (c = m[m.length - 1]) && c.parentNode && c.parentNode.removeChild(c))
	...
	H.fn.css = function(e, n) {
		...
		style: function(e, n, r, i) {
			if(e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
				...
				if("string" == (a = typeof r) && (o = Be.exec(r)) && (r = +(o[1] + 1) * +o[2] + parseFloat(H.css(e, n)), a = "number"), null == r || "number" === a && isNaN(r)) return;
		...
		css: function(e, n, r) {
			var i, o;
			return n = H.camelCase(n), o = H.cssHooks[n], "cssFloat" === (n = H.cssProps[n] || n) && (n = "float"), o && "get" in o && (i = o.get(e, !0, r)) !== t ? i : Le ? Le(e, n) : void 0
		},
		swap: function(e, t, n) {
			var r, i, o = {};
		...
		return t = t.replace(_e, "-$1").toLowerCase(), (r = e.ownerDocument.defaultView) && (i = r.getComputedStyle(e, null)) && "" === (n = i.getPropertyValue(t)) && !H.contains(e.ownerDocument.documentElement, e) && (n = H.style(e, t)), !H.support.pixelMargin && i && Pe.test(t) && Oe.test(n) && (o = a.width, a.width = n, n = i.width, a.width = o), n
	}), F.documentElement.currentStyle && (je = function(e, t) {
		var n, r, i, o = e.currentStyle && e.currentStyle[t],
			a = e.style;
		return null == o && a && (i = a[t]) && (o = i), Oe.test(o) && (n = a.left, (r = e.runtimeStyle && e.runtimeStyle.left) && (e.runtimeStyle.left = e.currentStyle.left), a.left = "fontSize" === t ? "1em" : o, o = a.pixelLeft + "px", a.left = n, r && (e.runtimeStyle.left = r)), "" === o ? "auto" : o
	...
	try {
		...
		(Ie = F.createElement("a")).href = "", Ie = Ie.href
	}
	$e = rt.exec(Ie.toLowerCase()) || [], H.fn.extend({
		...
		ajax: function(e, n) {
			...
			var i, o, a, s, l, f, d, h, m = H.ajaxSetup({}, n),
				g = m.context || m,
			...
			if(d = m.global, m.type = m.type.toUpperCase(), m.hasContent = !Je.test(m.type), d && 0 == H.active++ && H.event.trigger("ajaxStart"), !m.hasContent && (m.data && (m.url += (Ke.test(m.url) ? "&" : "?") + m.data, delete m.data), i = m.url, !1 === m.cache)) {
				var E = H.now(),
			...
			if(m.beforeSend && (!1 === m.beforeSend.call(g, C, m) || 2 === N)) return C.abort(), !1;
			for(h in {
					success: 1,
					error: 1,
					complete: 1
	...
	H.ajaxSetup({
		...
		if("jsonp" === t.dataTypes[0] || !1 !== t.jsonp && (ut.test(t.url) || i && ut.test(t.data))) {
			var o, a = t.jsonpCallback = H.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback,
				...
				u = t.data,
				c = "$1" + a + "$2";
			return !1 !== t.jsonp && (l = l.replace(ut, c), t.url === l && (i && (u = u.replace(ut, c)), t.data === u && (l += (/\?/.test(l) ? "&" : "?") + t.jsonp + "=" + a))), t.url = l, t.data = u, e[a] = function(e) {
				o = [e]
			}, r.always(function() {
		...
		if(e.crossDomain) {
			...
			return {
				send: function(i, o) {
					(n = F.createElement("script")).async = "async", e.scriptCharset && (n.charset = e.scriptCharset), n.src = e.url, n.onload = n.onreadystatechange = function(e, i) {
						...
						l.send(n.hasContent && n.data || null), r = function(e, i) {
							...
							try {
								if(r && (i || 4 === l.readyState))
									if(r = t, a && (l.onreadystatechange = H.noop, ft && delete ct[a]), i) 4 !== l.readyState && l.abort();
									else {
	...
	H.fn.extend({
		show: function(e, t, n) {
			...
			for(var s = 0, l = this.length; s < l; s++)(o = this[s]).style && (a = o.style.display, !H._data(o, "olddisplay") && "none" === a && (a = o.style.display = ""), ("" === a && "none" === H.css(o, "display") || !H.contains(o.ownerDocument.documentElement, o)) && H._data(o, "olddisplay", r(o.nodeName)));
			for(s = 0; s < l; s++)(o = this[s]).style && ("" !== (a = o.style.display) && "none" !== a || (o.style.display = H._data(o, "olddisplay") || ""));
			return this
		},
		hide: function(e, t, n) {
			if(e || 0 === e) return this.animate(i("hide", 3), e, t, n);
			for(var r, o, a = 0, s = this.length; a < s; a++)(r = this[a]).style && "none" !== (o = H.css(r, "display")) && !H._data(r, "olddisplay") && H._data(r, "olddisplay", o);
		...
		animate: function(e, t, n, i) {
			function o() {
				!1 === a.queue && H._mark(this);
				var t, n, i, o, s, l, u, c, f, d, p, h = H.extend({}, a),
					m = 1 === this.nodeType,
					g = m && H(this).is(":hidden");
				h.animatedProperties = {};
				for(i in e)
					if(t = H.camelCase(i), i !== t && (e[t] = e[i], delete e[i]), (s = H.cssHooks[t]) && "expand" in s) {
				...
				for(i in e) o = new H.fx(this, h, i), n = e[i], vt.test(n) ? (p = H._data(this, "toggle" + i) || ("toggle" === n ? g ? "show" : "hide" : 0)) ? (H._data(this, "toggle" + i, "show" === p ? "hide" : "show"), o[p]()) : o[n]() : (u = bt.exec(n), c = o.cur(), u ? (f = parseFloat(u[2]), "px" !== (d = u[3] || (H.cssNumber[i] ? "" : "px")) && (H.style(this, i, (f || 1) + d), c = (f || 1) / o.cur() * c, H.style(this, i, c + d)), u[1] && (f = ("-=" === u[1] ? -1 : 1) * f + c), o.custom(c, f, d)) : o.custom(c, n, ""));
				return !0
			}
			var a = H.speed(t, n, i);
			return H.isEmptyObject(e) ? this.each(a.complete, [!1]) : (e = H.extend({}, e), !1 === a.queue ? this.each(o) : this.queue(a.queue, o))
		},
		stop: function(e, n, r) {
		...
		speed: function(e, t, n) {
			...
			return r.duration = H.fx.off ? 0 : "number" == typeof r.duration ? r.duration : r.duration in H.fx.speeds ? H.fx.speeds[r.duration] : H.fx.speeds._default, null != r.queue && !0 !== r.queue || (r.queue = "fx"), r.old = r.complete, r.complete = function(e) {
				H.isFunction(r.old) && r.old.call(this), r.queue ? H.dequeue(this, r.queue) : !1 !== e && H._unmark(this)
			}, r
		},
		easing: {
			linear: function(e) {
		...
		step: function(e) {
			...
			if(e || i >= l.duration + this.startTime) {
				...
				for(t in l.animatedProperties) !0 !== l.animatedProperties[t] && (o = !1);
				if(o) {
		...
		tick: function() {
			for(var e, t = H.timers, n = 0; n < t.length; n++) !(e = t[n])() && t[n] === e && t.splice(n--, 1);
			t.length || H.fx.stop()
		},
		interval: 13,
		stop: function() {
	...
	Tt = "getBoundingClientRect" in F.documentElement ? function(e, t, r, i) {
		...
		var o = t.body,
			...
			u = a.pageYOffset || H.support.boxModel && r.scrollTop || o.scrollTop,
			c = a.pageXOffset || H.support.boxModel && r.scrollLeft || o.scrollLeft;
		return {
			top: i.top + u - s,
			left: i.left + c - l
		}
		...
		for(var r, i = e.offsetParent, o = t.body, a = t.defaultView, s = a ? a.getComputedStyle(e, null) : e.currentStyle, l = e.offsetTop, u = e.offsetLeft;
			(e = e.parentNode) && e !== o && e !== n && (!H.support.fixedPosition || "fixed" !== s.position);) r = a ? a.getComputedStyle(e, null) : e.currentStyle, l -= e.scrollTop, u -= e.scrollLeft, e === i && (l += e.offsetTop, u += e.offsetLeft, H.support.doesNotAddBorder && (!H.support.doesAddBorderForTableAndCells || !wt.test(e.nodeName)) && (l += parseFloat(r.borderTopWidth) || 0, u += parseFloat(r.borderLeftWidth) || 0), i, i = e.offsetParent), H.support.subtractsBorderForOverflowNotVisible && "visible" !== r.overflow && (l += parseFloat(r.borderTopWidth) || 0, u += parseFloat(r.borderLeftWidth) || 0), s = r;
		return "relative" !== s.position && "static" !== s.position || (l += o.offsetTop, u += o.offsetLeft), H.support.fixedPosition && "fixed" === s.position && (l += Math.max(n.scrollTop, o.scrollTop), u += Math.max(n.scrollLeft, o.scrollLeft)), {
			top: l,
			left: u
		}
		...
		setOffset: function(e, t, n) {
			...
			var i, o, a = H(e),
				...
				c = {},
				f = {};
			("absolute" === r || "fixed" === r) && H.inArray("auto", [l, u]) > -1 ? (f = a.position(), i = f.top, o = f.left) : (i = parseFloat(l) || 0, o = parseFloat(u) || 0), H.isFunction(t) && (t = t.call(e, n, s)), null != t.top && (c.top = t.top - s.top + i), null != t.left && (c.left = t.left - s.left + o), "using" in t ? t.using.call(e, c) : a.css(c)
		}
	}, H.fn.extend({
		position: function() {
		...
		H.fn[e] = function(o) {
			return H.access(this, function(e, o, a) {
				var s = n(e);
				if(a === t) return s ? r in s ? s[r] : H.support.boxModel && s.document.documentElement[o] || s.document.body[o] : e[o];
				s ? s.scrollTo(i ? H(s).scrollLeft() : a, i ? a : H(s).scrollTop()) : e[o] = a
		...
		H.fn["inner" + e] = function() {
			...
			return H.access(this, function(e, n, a) {
				var s, l, u, c;
				return H.isWindow(e) ? (s = e.document, l = s.documentElement[r], H.support.boxModel && l || s.body && s.body[r] || l) : 9 === e.nodeType ? (s = e.documentElement)[r] >= s[i] ? s[r] : Math.max(e.body[i], s[i], e.body[o], s[o]) : a === t ? (u = H.css(e, n), c = parseFloat(u), H.isNumeric(c) ? c : u) : void H(e).css(n, a)
