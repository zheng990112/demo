$(function(){	
	var banner_h = Math.floor($('.er-banner .banner-list li img').height());
	$('.er-banner').height(banner_h);
...
//	var a_length = $(".header .nav ul li .item a").length;
//	var a_width = Math.floor($('.header .nav ul li .item a').width());
//	console.log(a_length);
//	console.log(a_width);
//	$('.header .nav ul li .item').width(a_length * a_width + a_length) ;
})
