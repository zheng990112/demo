...
//		console.log(scrollTop);
    	...
    	}if(scrollTop > w_h*0.94){
			$(".er-title").addClass("er-title-fix");
			$(".firstAnchor").addClass("firstAnchor2");
    	}else{
    		$('.backTop').fadeOut();
			$(".er-title").removeClass("er-title-fix");
			$(".firstAnchor").removeClass("firstAnchor2");
    	...
    	if(scrollTop >= 700){
    		$(".big_logo").addClass("none");
    		$(".menu").addClass("none");
    		$(".header_content").removeClass("none");
    		$(".banner-list").addClass("none");
    		
    	}else if(scrollTop < 600){
    		$(".big_logo").removeClass("none");
    		$(".menu").removeClass("none");
    		$(".header_content").addClass("none");
    		$(".banner-list").removeClass("none");
    	};
    	
    	if(scrollTop >= 2400 && scrollTop <= 3800){
    		$(".part4_main1_bg").addClass("imgfixed");
    	}else{
    		$(".part4_main1_bg").removeClass("imgfixed");
    	}
