...
//				})
			...
			_initPaging : function(){
				...
				var pageHtml = "<div id='pages'><ul class="+pagesClass+">";
				for(var i = 0 ; i < me.pagesCount; i++){
					pageHtml += "<li></li>";
				}
				var pageWrap = "<span class='pageUp'></span><span class='pageDown'></span>";
			...
			_initEvent : function(){
				...
				// 点击箭头，上下翻页
				me.element.on("click", '.pageUp', function(){
					me.prve();
				});
				me.element.on("click", '.pageDown', function(){
					me.next();
				});
			...
			_scrollPage : function(init){
				...
				if(_prefix){
					...
					//页面滚动的动画 
					window._animateName = "fadeIn fadeInRight fadeInLeft fadeInUp fadeInDown zoomIn hidden scaleIn rotate";
					if($(".section").length>0){
