$(function() {
    var img_H = $('.banner .banner-list').find('li').eq(0).find('img')[0].naturalHeight;
    var img_W = $('.banner .banner-list').find('li').eq(0).find('img')[0].naturalWidth;
    var banner_h = $(window).width() * img_H / img_W;
    ...
    console.log()
        // var banner_h = Math.floor($('.banner .banner-list li').height());
        // $('.banner').height(banner_h);
...
//      var topHeader = 120 + $('.banner .banner-list li').height() + $(".content .nav").height();
        var topHeader = 120 + $('.banner .banner-list li').height();
		var dom = $(".er-nav")[0].offsetTop - scrollTop;
//		var dom = $(".er-nav")[0].getBoundingClientRect();
//		var dom = $(".er-nav")[0].getBoundingClientRect().top;
