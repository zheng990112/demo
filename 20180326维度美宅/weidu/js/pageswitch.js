...
//				})
			...
			_scrollPage : function(init){
				...
				if(_prefix){
					...
					//页面滚动的动画
					window._animateName = "rotateInDownLeft fadeIn bounce fadeInRight fadeInLeft fadeInUp fadeInDown zoomIn hidden scaleIn rotate rubberBand shake headShake swing tada wobble";
					if($(".section").length>0){
