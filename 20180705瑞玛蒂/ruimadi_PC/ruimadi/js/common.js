$(function(){
	var banner_h = $(window).width() * 0.4104;
...
//	返回顶部
	...
	$(".title1").mouseover(function(){
		$(".er-nav .title1-2").css("display","block");
	})
	$(".er-nav .title1-2").mouseover(function(){
		$(".er-nav .title1-2").css("display","block");
	})
	$(".title1").mouseout(function(){
		$(".er-nav .title1-2").css("display","none");
	})
	$(".er-nav .title1-2").mouseout(function(){
		$(".er-nav .title1-2").css("display","none");
	})
})
