$(function(){	
	...
	var banner_h = $('.banner .banner-list li img').height();
	
//	$('.banner').height(banner_h);
	$('.header-box').height(banner_h);
...
//		console.log(scrollTop)
	...
	$(".close-btn").on('click',function(){
		$(".fixnav").animate({right:"-192px"},"500");
		$(".fixnav .nav-img").animate({opacity:"1"},"1000");
	})
	$(".fixnav .nav-img").on('click',function(){
		$(".fixnav").animate({right:"100px"},"500");
		$(".fixnav .nav-img").animate({opacity:"0"},"1000");
	})
