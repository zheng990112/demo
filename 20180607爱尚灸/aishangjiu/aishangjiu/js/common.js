$(function(){	
	...
	var banner_h = $(window).width() * 0.4786;
...
//	$(".nav ul li .title").mouseover(function(){
//		$(".nav ul li .item").slideDown(1500)
//	})
//	$(".nav ul li .title").mouseleave(function(){
//		$(".nav ul li .item").slideUp(1500)
//	})
