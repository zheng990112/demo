...
$(function() {
    ...
    $(".close-btn").on('click', function() {
        $(".Floating").animate({ right: "-200px" }, "500");
        $(".Floating .Floating_icon").animate({ opacity: "1" }, "1000");
    })
    $(".Floating .Floating_icon").on('click', function() {
        $(".Floating").animate({ right: "0" }, "500");
        $(".Floating .Floating_icon").animate({ opacity: "0" }, "1000");
    })
